...
/// Back button with glass effect for bookings header.
///
/// Features animated scale effect on tap with haptic feedback.
class HeaderBackButton extends StatefulWidget {
  final VoidCallback onTap;

  const HeaderBackButton({required this.onTap, super.key});
