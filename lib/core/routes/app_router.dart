// // Deprecated: legacy Navigator-based router kept for reference only.
// // All navigation now uses GoRouter via AppRouterConfig (lib/core/routes/go_router_config.dart).
...
// /// ```
// @Deprecated('Use AppRouterConfig (GoRouter) instead. This legacy router will be removed.')
// class AppRouter {
